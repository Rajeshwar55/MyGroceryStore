        ...
        <NavLink to='/'>
          <img className='h-9' src={assets.logo} alt="logo" />
                ...
                <div className="relative cursor-pointer">
                 ...
                 <div className='relative group'>
                  ...
                  <ul className='hidden group-hover:block absolute top-10 right-0 bg-white shadow border-gray-200 py-2.5 w-30 rounded-md text-sm z-40'>
                    <li onClick={()=>navigate('myorders')} className='p-1.5 pl-3 hover:bg-primary/10 cursor-pointer'>MyOrders</li>
            ...
            <div className={`${open ? 'flex' : 'hidden'} absolute top-[60px] left-0 w-full bg-white shadow-md py-4 flex-col items-start gap-2 px-5 text-sm md:hidden`}>
                ...
                {
                  user && <NavLink to='/myorders' onClick={()=>setOpen(false)}>MyOrders</NavLink>
                }
